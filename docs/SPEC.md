...
- 문서 버전: 0.3.0 (2026-09-04, Phase 4 리팩터·개인용 standalone 게이트 추가)
...
- **Phase 5 — 확장**: K 및 `docs/FUTURE.md`에 쌓인 항목.
...
- 광고, 분석용 원격 수집(텔레메트리)
- 앱 스토어 공개 배포·결제·다중 사용자 상용 운영 준비(Phase 4S 개인용 standalone과 별도이며 Q-005 승인 뒤 범위를 확정)
...
### 5.1 공통
- 하단 탭 5개: **오늘 / 주간 / 프로젝트 / 계획 / 분석** (+ 설정은 헤더 아이콘). Phase 4 구현 전에는 분석 탭에 "Phase 4에서 활성화" 안내만 둔다.
...
| 개인용 standalone | Android 우선, PC·Metro 불필요 | Phase 4R 통과 뒤 Phase 4S에서 검증. 공개 스토어·결제는 Q-005와 별도 |
