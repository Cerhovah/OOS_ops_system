...
4. 승인 후보 Figma `P5 Visual v2` core/edge screenshot
...
- timespent: surface hierarchy, spacing density, typography hierarchy, row treatment, control visual weight
- Tiimo: Today → 선택 → 실행 → 종료 → 목록/기록 반영의 맥락 연속성
- Equinox+: Records hierarchy와 절제된 dark mode
